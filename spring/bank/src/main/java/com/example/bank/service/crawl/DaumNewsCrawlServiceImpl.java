package com.example.bank.service.crawl;

import com.example.bank.entity.crawl.DaumNews;
import com.example.bank.repository.crawl.DaumNewsCrawlRepository;
...
public class DaumNewsCrawlServiceImpl implements DaumNewsCrawlService {
    ...
    public void daumNewsMainCrawler(String category) {
        ...
        //Ex 경제 카테고리에서 오른쪽클릭후 inspect해서 나오는거 오른클릭-copy-select해서 수정한게 "div.mai어쩌구"
